        ...
        if (!p[l]) {
            ...
            var b = function(h, i, g) {
                ...
                var k = new Date / 1E3,
                    ...
                    q = 1,
                    o = false,
                    u = {}, E = typeof h === "string" ? p.dom.find(h) : h,
                    C = {};
...
(function(p, e) {
    ...
    p.plugin("documentcloud", {
        ...
        _setup: function(d) {
            ...
            var i = window.DV = window.DV || {}, g = this;
            if (i.loading) h();
            else {
                i.loading = true;
...
(function(p) {
    ...
    p.plugin("mediaspawner", {
        ...
        _setup: function(b) {
            ...
            var g = document.getElementById(b.target) || {}, k, r, m;
        ...
        var h = document.createElement("div"),
            ...
            g = function() {
                if (l) d.feed = new GFdynamicFeedControl(d.url, h, {
                    ...
                    horizontal: d.orientation.toLowerCase() === "horizontal" ? true : false,
